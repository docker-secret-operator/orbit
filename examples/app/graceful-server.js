/**
 * Node.js production server with graceful SIGTERM handling for Docker Rollout.
 *
 ...
 *
 * How it integrates with Docker Rollout:
 *   - Docker HEALTHCHECK uses /health/ready
 *   - docker-rollout rollout waits for /health/ready to return 200
 *   - On SIGTERM (container stop), the server drains for up to 30s
 *   - In-flight requests complete; no 502 errors at the nginx/docker-rollout layer
 */
...
// Docker / docker-rollout sends SIGTERM before killing the container.
// Steps:
