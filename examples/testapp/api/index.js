...
// Readiness: all deps reachable. docker-rollout rollout waits for 200 before switching traffic.
...
async function start() {
  ...
  // docker-rollout proxy drains connections first (drain period), then Docker sends
