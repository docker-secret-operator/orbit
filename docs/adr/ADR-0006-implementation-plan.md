...
| **`proxy.ProjectRegistry`** (new) | `For(service string) (*Registry, bool)`, a constructor `NewProjectRegistry(services []string) *ProjectRegistry` | — | N/A, new type | New surface, no existing callers to break |
